...
- Character counts (measure after any edit with `printf '%s' | wc -c`): instruction 6,050; routing_condition 1,018 (measured, binary authenticated model + structured-report contract).
