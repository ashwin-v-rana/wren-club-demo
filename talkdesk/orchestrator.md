...
- Character counts (measure after any edit with `printf '%s' | wc -c`): instruction 7,805; routing_condition 1,411 (measured after the disambiguation was hardened to MANDATORY; binary authenticated model + structured-report contract).
