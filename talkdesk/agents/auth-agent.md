...
**Character count:** 9,085 (measured; limit 20,000). Re-measure with `printf '%s' | wc -c` after any edit.
...
- Measured instruction count: 9,085 characters (limit 20,000). Re-measure after any edit.
