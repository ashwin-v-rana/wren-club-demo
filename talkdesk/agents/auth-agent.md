...
**Character count:** 6,292 (measured; limit 20,000). Re-measure with `printf '%s' | wc -c` after any edit.
...
- Measured instruction count: 6,292 characters (limit 20,000). Re-measure after any edit.
